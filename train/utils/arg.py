...
parser.add_argument("--epochs", type=int, default=50) #만약 pretrain 모델을 불러오면 필요없음
parser.add_argument("--optimizer", "-opt", type=str, default="AdamW")
parser.add_argument("--scheduler","-s", type=str, default="lambda")
parser.add_argument("--loss", "-l", type=str, default="bce")
parser.add_argument("--valid_epoch","-ve", type=int, default=8)
############################################################################
# Model Save
